...
public class FindMultipleElements {
    ...
    public static void main(String[] args) {
        ...
        // Get the first item and get text
        ...
        // findElement method will throw exception when it cannot find element
        // findElements method will return empty List<WebElements>
