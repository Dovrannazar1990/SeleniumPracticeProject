...
public class XPathPractice1 {
    ...
    public static void main(String[] args) {
        ...
        //h4[@name='confirmation_message' and text()='Your e-mail's sent!']
        //h4[@name='confirmation_message']
        //h4[text()='Your e-mail's sent!']
        //h4[.='Your e-mail's sent!']
         */
        ...
        // WebElement confirmationMsg = driver.findElement(By.xpath("//h4[text()=\"Your e-mail's sent!\"]"));
